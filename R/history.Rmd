...
#nyc <- weekly.deltas(
#  subset(zoo.nyt(State=='New York' & County=='New York City'), confirmed > 0)
#)/8.398748
...
wa.usa <- weekly.deltas(zoo.nyt.micro(State=='Washington'))
ma.usa <- weekly.deltas(zoo.nyt.micro(State=='Massachusetts'))
ca.usa <- weekly.deltas(zoo.nyt.micro(State=='California'))
