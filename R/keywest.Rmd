...
Middlesex <- zoo.jhu.US.micro(State=='Massachusetts' & County=='Middlesex')$deaths
...
fracmort <- window(cbind(US, NYC, Lombardy.Italy, Middlesex, Belgium, Sweden)/1e6,
               start="2020-03-15")
fracmort <- merge(local=local$deaths/1e6, fracmort)
